...
from app.custom_strategy import StoreBothLossesSaveOnFinalFedAvg, make_on_final_parameters
...
def server_fn(context: Context):
    ...
    strategy = StoreBothLossesSaveOnFinalFedAvg(
        ...
        loss_history_path=None, # use in case you also want to save a CSV             
